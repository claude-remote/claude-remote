...
const useFrustrationDetection: typeof import('../components/FeedbackSurvey/useFrustrationDetection.js').useFrustrationDetection = IS_ANT_BUILD
...
const useAntOrgWarningNotification: typeof import('../hooks/notifs/useAntOrgWarningNotification.js').useAntOrgWarningNotification = IS_ANT_BUILD
  ? require('../hooks/notifs/useAntOrgWarningNotification.js').useAntOrgWarningNotification
  : () => {};
const fireCompanionObserver = async (
  _messages: MessageType[],
  _onReaction: (reaction: string | null) => void,
): Promise<void> => {};
...
export function REPL({
  ...
  const moreRightEnabled = useMemo(
    () => IS_ANT_BUILD && isEnvTruthy(process.env.CLAUDE_MORERIGHT),
    [],
  );
  ...
  function getFocusedInputDialog():
    ...
    if (IS_ANT_BUILD && allowDialogsWithAnimation && showUndercoverCallout)
  ...
  const getToolUseContext = useCallback(
    (
      ...
      return {
        ...
        setResponseLength,
        pushApiMetricsEntry: IS_ANT_BUILD
          ? (ttftMs: number) => {
              const now = Date.now();
      ...
      handleMessageFromStream(
        ...
        (newMessage) => {
          if (isCompactBoundaryMessage(newMessage)) {
            ...
            (newMessage as any).type === 'progress' &&
            ...
            setMessages((oldMessages) => {
              ...
              if (
                last?.type === 'progress' &&
                last.parentToolUseID === (newMessage as any).parentToolUseID &&
                last.data.type === (newMessage as any).data.type
              ) {
  ...
  useEffect(() => {
    ...
    async function processInitialMessage(initialMsg: NonNullable<typeof pending>) {
      ...
      const shouldStorePlanForVerification =
        initialMsg.message.planContent && IS_ANT_BUILD && isEnvTruthy(undefined);
      setAppState((prev) => {
        ...
        <FullscreenLayout
          ...
          scrollable={
            <>
              ...
              {IS_ANT_BUILD && <TungstenLiveMonitor />}
          ...
          bottom={
            ...
            >
              ...
              <Box flexDirection="column" flexGrow={1}>
                ...
                {IS_ANT_BUILD && focusedInputDialog === 'model-switch' && AntModelSwitchCallout && (
                ...
                {!toolJSX?.shouldHidePromptInput &&
                  ...
                  !cursor && (
                    <>
                      ...
                      {IS_ANT_BUILD && skillImprovementSurvey.suggestion && (
