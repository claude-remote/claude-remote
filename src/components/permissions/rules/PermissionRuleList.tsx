...
export function PermissionRuleList(t0) {
  ...
  if (
    ...
    t21 = () => {
      ...
      const { options: options_0 } = getRulesOptions(currentRule.ruleBehavior as TabType);
      ...
      setChanges((prev_2) => [
        ...prev_2,
        `Deleted ${currentRule.ruleBehavior} rule ${chalk.bold(permissionRuleValueToString(currentRule.ruleValue))}`,
      ]);
