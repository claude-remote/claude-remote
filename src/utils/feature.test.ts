...
describe('feature', () => {
  test('returns false by default when no runtime feature source exists', () => {
    delete process.env.CLAUDE_REMOTE_FEATURES
    delete process.env.CLAUDE_CODE_FEATURES
    delete process.env.CLAUDE_REMOTE_FEATURE_BRIDGE_MODE
    delete process.env.CLAUDE_CODE_FEATURE_BRIDGE_MODE
